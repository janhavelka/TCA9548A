...
/// @param address Candidate 7-bit I2C address.
/// @return true for addresses 0x70 through 0x77; otherwise false.
...
/// @param a2 true when address pin A2 is tied high.
/// @param a1 true when address pin A1 is tied high.
/// @param a0 true when address pin A0 is tied high.
/// @return Encoded 7-bit address in the range 0x70 through 0x77.
